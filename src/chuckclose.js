...
/*
 Returns a Texture signal with an effect already applied.
*/

function ChuckClose(size, step, materialId, cameraTextureId) {
    ...
    const cameraTexture = Textures.get(cameraTextureId);
    ...
    const filtered = R.mix(sampled1, sampled2, R.mod(f, 1.0));
